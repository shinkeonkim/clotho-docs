...
export const navigation = [
  ...
  },
  {
    ...
    items: [
      ["/docs/skill/overview", "스킬 안내", "Skill overview"],
      ["/docs/skill/schema", "Schema reference", "Schema reference"],
      ["/docs/skill/patterns", "작성 패턴", "Authoring patterns"],
      ["/docs/skill/chart", "차트", "Charts"],
      ["/docs/skill/style", "렌더 스타일", "Render style"],
      ["/docs/skill/math", "수식", "Math"],
      ["/docs/skill/tooling", "CLI 도구", "CLI tools"],
      ["/docs/skill/embedding", "문서에 끼워 넣기", "Embedding"],
      [
